...
namespace _04supermercado
{
    class Program
    {
        ...
        {
            /* Producto prod1 = new Producto ("pan", 10, 5);
            Producto prod2 = new Producto ("agua", 2, 3);
            Producto prod3 = new Producto ("harina", 6, 3);
            Producto prod4 = new Producto ("leche", 5, 5);
            Producto prod5 = new Producto ("aceite", 9, 1);   */        
